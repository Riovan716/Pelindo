...
<div class="main-card">
    <div class="form-title">Form Tambah Lowongan Pekerjaan</div>
    @if(session('success'))
    ...
    <form method="POST" action="{{ route('admin.lowongan.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="judul" id="judul" placeholder="Judul" value="{{ old('judul') }}">
            @error('judul') <div class="form-error">{{ $message }}</div> @enderror
        </div>
        <div class="form-group">
            <label for="deskripsi">Deskripsi</label>
            <textarea name="deskripsi" id="deskripsi" placeholder="Deskripsi...">{{ old('deskripsi') }}</textarea>
            @error('deskripsi') <div class="form-error">{{ $message }}</div> @enderror
        </div>
        <div class="form-group">
            <label for="kualifikasi">Kualifikasi</label>
            <textarea name="kualifikasi" id="kualifikasi" placeholder="Kualifikasi...">{{ old('kualifikasi') }}</textarea>
            @error('kualifikasi') <div class="form-error">{{ $message }}</div> @enderror
        </div>
        <div class="form-group">
            <label for="keahlian">Keahlian</label>
            <textarea name="keahlian" id="keahlian" placeholder="Keahlian...">{{ old('keahlian') }}</textarea>
