...
<div class="container">
    ...
    <div class="form-card">
        <div class="form-header">
            <h1>Edit Berita</h1>
            <p>Ubah informasi berita di bawah ini</p>
        </div>
        ...
        <form action="{{ route('admin.berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="judul" id="judul" placeholder="Masukkan judul berita..." required value="{{ old('judul', $berita->judul) }}">
            </div>

            <div class="form-group">
                <label for="isi">Isi Berita *</label>
                <textarea name="isi" id="isi" placeholder="Tulis isi berita di sini..." required>{{ old('isi', $berita->isi) }}</textarea>
            </div>
