...
@section('content')
    <div class="diklat-form-container">
        <div class="diklat-form-header">
            <h1><i class="fas fa-plus-circle"></i> Tambah Diklat</h1>
            <p>Isi data diklat dengan lengkap dan benar</p>
        </div>
        <form method="POST" action="{{ route('admin.diklat.store') }}" class="diklat-form-card" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="link" id="link" class="form-control" value="{{ old('link') }}" placeholder="Masukkan link terkait (jika ada)">
