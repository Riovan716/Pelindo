...
<div class="diklat-form-container">
    <div class="diklat-form-header">
        <h1><i class="fas fa-plus-circle"></i> Tambah Skripsi Baru</h1>
        <p>Isi data skripsi dengan lengkap dan benar</p>
    </div>
    
    <form action="{{ route('admin.skripsi.store') }}" method="POST" class="diklat-form-card" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-row">
            <div class="form-group full-width">
                ...
                <textarea class="form-control @error('abstrak') is-invalid @enderror" 
                          ...
                          placeholder="Masukkan abstrak skripsi...">{{ old('abstrak') }}</textarea>
                @error('abstrak')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-row">
            <div class="form-group">
                <label>File Skripsi (PDF) <span class="required">*</span></label>
        ...
        <div class="info-card">
            ...
            <ul>
                <li>File skripsi harus dalam format PDF</li>
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-save"></i> Simpan Skripsi
            </button>
